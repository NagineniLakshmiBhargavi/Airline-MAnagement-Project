...
<form name=cosmos action=cosmosupd.jsp>
<center>
...
<input value=<%=rs.getString(1) %> name=userid type=text  size=20  ></td></tr>
<tr><td class=td><b>Password *</b></td><td>
<input name=password type=text value=<%=rs.getString(2) %>  size=10  ></td></tr>
...
<input value=<%=rs.getString(3) %> name=fname type=text  size=20  ></td></tr>
<tr><td class=td><b>Last Name *</b></td><td>
<input name=lname type=text  value=<%=rs.getString(4) %>  size=20  ></td></tr>

<%

java.text.SimpleDateFormat fmt=new java.text.SimpleDateFormat("dd-MMM-yy");
String msgdate=fmt.format(rs.getDate(5)).toString();

%>

<tr><td class=td><b>Date of Birth</b></td><td>
<input  value=<%=msgdate %>  name=dob type=text  size=8 onfocus='dd();'></td></tr>
...
<input  value=<%=rs.getString(7) %> name=education type=text  size=20  ></td></tr>
<tr><td class=td><b>Occupation</b></td><td>
<input name=occupation  value=<%=rs.getString(8) %> type=text  size=20 ></td></tr>
<tr><td class=td><b>Nationality</b></td><td>
<input name=nationality  value=<%=rs.getString(9) %> type=text  size=20  ></td></tr>
    <tr>
      <td width="100%" height="21" colspan="2" bgcolor="red">&nbsp;</td>
    </tr>

<tr><td class=td><b>Present Address</b></td><td>
<input name=paddress type=text  size=30   value=<%=rs.getString(10) %> ></td></tr>
<tr><td class=td><b>Permanent address</b></td><td>
<input name=praddress type=text  size=30   value=<%=rs.getString(11) %> ></td></tr>
...
<input name=zip type=text  size=10  value=<%=rs.getInt(14) %> onkeypress='if(event.keyCode<48 || event.keyCode>58){cosmos.zip.focus(); return false;}if(cosmos.zip.value.length>10)return false;'></td></tr>
    <tr>
      <td width="100%" height="21" colspan="2" bgcolor="red">&nbsp;</td>
    </tr>

<tr><td class=td><b>Phone Number</b></td><td>
<input name=phone type=text  size=10  value=<%=rs.getInt(15) %> onkeypress='if(event.keyCode<48 || event.keyCode>58){cosmos.phone.focus(); return 
false;}if(cosmos.phone.value.length>10)return false;'></td></tr>

<tr><td class=td><b>Mobile Number</b></td><td>
<input name=mobile type=text  size=10  value=<%=rs.getInt(16) %>  onkeypress='if(event.keyCode<48 || event.keyCode>58){cosmos.mobile.focus(); return false;}if(cosmos.mobile.value.length>10)return false;'></td></tr>
<tr><td class=td><b>Other Information</b></td><td>
<textarea rows=5 cols=25 name=oinfo> <%=rs.getString(17) %> </textarea></td></tr>
    <tr>
      <td width="100%" height="21" colspan="2" bgcolor="red">&nbsp;</td>
    </tr>
...
<input name=creditcardno type=text  size=15  value=<%=rs.getString(19) %> ></td></tr>
<tr><td class=td><b>Credit Password *</b></td><td>
<input name=cpassword type=password  size=15  value=<%=rs.getString(20) %> ></td></tr>
</table>
